        ...
        <div class="shell">
            ...
            <div id="content" height="600px">
                ...
                <form method="post" action="Update.php" onsubmit="return check_update()">
                    ...
                    echo'<div id= "edit"><a href="http://localhost/ImageGallery/images/' . $info['image'] . '" rel="lightbox[roadtrip]" class="big-image">
                    <img src="http://localhost/ImageGallery/images/' . $info['image'] . '" width="259px" height="194px"></a></div>
                    ...
                    <tr><td>Category Name:</td><td><input type=txt name="category" id="category" value="' . $info['category_name'] . '"></td>
                        <td><span id="errorcategory" class="formError"></span></td></tr>';
                    ?>
